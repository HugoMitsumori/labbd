...
class FreelancerKnowledgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create freelancer_knowledge" do
    assert_difference('FreelancerKnowledge.count') do
      post freelancer_knowledges_url, params: { freelancer_knowledge: { certificates: @freelancer_knowledge.certificates, freelancer_login: @freelancer_knowledge.freelancer_login, knowledge_name: @freelancer_knowledge.knowledge_name } }
    end
  ...
  test "should update freelancer_knowledge" do
    patch freelancer_knowledge_url(@freelancer_knowledge), params: { freelancer_knowledge: { certificates: @freelancer_knowledge.certificates, freelancer_login: @freelancer_knowledge.freelancer_login, knowledge_name: @freelancer_knowledge.knowledge_name } }
