...
class FreelancersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create freelancer" do
    assert_difference('Freelancer.count') do
      post freelancers_url, params: { freelancer: { avaliacao_media: @freelancer.avaliacao_media, login: @freelancer.login } }
    end
  ...
  test "should update freelancer" do
    patch freelancer_url(@freelancer), params: { freelancer: { avaliacao_media: @freelancer.avaliacao_media, login: @freelancer.login } }
