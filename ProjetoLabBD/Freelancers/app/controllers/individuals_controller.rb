class IndividualsController < ApplicationController
  ...
  # Individual.create({:login => "login", :name => "name"}).save
  # Individual.all = array de Individuals
  # Individual.followers << @individual2
  ...
  private
    ...
    def individual_params
      params.require(:individual).permit(:name, :email)
    end
end
