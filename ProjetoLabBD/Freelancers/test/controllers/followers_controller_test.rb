...
class FollowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post followers_url, params: { follower: { followed_login: @follower.followed_login, follower_login: @follower.follower_login } }
    end
  ...
  test "should update follower" do
    patch follower_url(@follower), params: { follower: { followed_login: @follower.followed_login, follower_login: @follower.follower_login } }
