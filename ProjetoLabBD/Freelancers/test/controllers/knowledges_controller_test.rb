...
class KnowledgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create knowledge" do
    assert_difference('Knowledge.count') do
      post knowledges_url, params: { knowledge: { description: @knowledge.description, name: @knowledge.name } }
    end
  ...
  test "should update knowledge" do
    patch knowledge_url(@knowledge), params: { knowledge: { description: @knowledge.description, name: @knowledge.name } }
