...
class MigrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create migration" do
    assert_difference('Migration.count') do
      post migrations_url, params: { migration: { RemoveCompanyFromContractors: @migration.RemoveCompanyFromContractors, company_id: @migration.company_id } }
    end
  ...
  test "should update migration" do
    patch migration_url(@migration), params: { migration: { RemoveCompanyFromContractors: @migration.RemoveCompanyFromContractors, company_id: @migration.company_id } }
